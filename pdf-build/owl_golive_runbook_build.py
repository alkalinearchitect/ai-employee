#!/usr/bin/env python3
# owl_golive_runbook_build.py — generate Owl Go-Live Runbook PDF
import sys
sys.path.insert(0, "/root/ai-employee/pdf-build")
from owl_golive_runbook_content import PAGES, COVER, SITE, BOOK
...
def bg_shape(c, d):
    ...
    c.drawString(18*mm, 9*mm, "OWL GO-LIVE RUNBOOK · Human Architect")
...
if __name__ == "__main__":
    build("/root/ai-employee/pdf-build/owl-golive-runbook.pdf")
