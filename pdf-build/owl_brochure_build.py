...
from owl_brochure_content import PAGES, COVER, SITE, BOOK
...
def bg_shape(c, d):
    ...
    c.setFillColor(ACC)
    c.setFillAlpha(0.10)
    c.circle(A4[0]*0.82, A4[1]*0.92, 230, fill=1, stroke=0)
    c.setFillAlpha(0.05)
    c.circle(A4[0]*0.2, A4[1]*0.1, 180, fill=1, stroke=0)
    c.setFillAlpha(1)
    ...
    c.drawString(18*mm, 9*mm, "OWL BROCHURE · Human Architect")
...
def cover_bg(c, d):
    ...
    c.setFillAlpha(0.06)
    c.circle(A4[0]*0.5, A4[1]*0.62, 420, fill=1, stroke=0)
    c.setFillAlpha(1)
    c.setFillColor(ACC)
    c.rect(18*mm, A4[1]-150*mm, 26*mm, 2.4, fill=1, stroke=0)
    c.restoreState()
...
if __name__ == "__main__":
    build("/root/ai-employee/pdf-build/owl-brochure.pdf")
